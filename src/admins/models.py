...
def default_generate_key():
    number = random.randint(9999999, 999999999)
    if Order.objects.filter(transaction_id=number):
        default_generate_key()
    return number
...
class Order(models.Model):
    ...
    transaction_id = models.CharField(max_length=2000, null=False, blank=False, default=default_generate_key)
