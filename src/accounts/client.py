...
class OAuth2Client(object):
    ...
    def get_access_token(self, code):
        ...
        header = self.headers
        method_access = self.access_token_method
        ...
        #     data={
        #         'grant_type': 'authorization_code',
        #         'code': '4/0AX4XfWg9iJO6djQb39aPbmWiaxt4tZy-l9l5HomP_sZXK0JfhjsogGjYoutt5qbhPPVrhA',
        #         'client_id': '370944119419-lcf8s0uj0uhe74cckc2kt9sbekg17lm7.apps.googleusercontent.com',
        #         'client_secret': 'i5_Pq1WZvK-Z5p0p60VMC4w3',
